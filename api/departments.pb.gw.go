...
func request_DepartmentService_GetDepartment_0(ctx context.Context, marshaler runtime.Marshaler, client DepartmentServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	protoReq.DepartmentId, err = runtime.Uint32(val)
...
func RegisterDepartmentServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DepartmentServiceClient) error {
	...
	mux.Handle("GET", pattern_DepartmentService_ListDepartments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DepartmentService_ListDepartments_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_DepartmentService_ListDepartments_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_DepartmentService_GetDepartment_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DepartmentService_GetDepartment_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_DepartmentService_GetDepartment_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_DepartmentService_ListDepartments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"departments"}, ""))

	pattern_DepartmentService_GetDepartment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"departments", "department_id"}, ""))
)
