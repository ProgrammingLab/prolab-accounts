...
var (
	userColumns               = []string{"id", "name", "email", "full_name", "avatar_filename", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "email", "full_name", "avatar_filename", "created_at", "updated_at"}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to populate default values for users")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dao: unable to retrieve unique values for users")
	}
