...
func testUserToManyAchievementUsers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadAchievementUsers(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyBlogs(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadBlogs(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAuthorEntries(t *testing.T) {
	...
	check, err := a.AuthorEntries().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadAuthorEntries(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.AuthorEntries); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.AuthorEntries = nil
	if err = a.L.LoadAuthorEntries(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.AuthorEntries); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyGithubContributionDays(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, githubContributionDayDBTypes, false, githubContributionDayColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, githubContributionDayDBTypes, false, githubContributionDayColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.GithubContributionDays().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadGithubContributionDays(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.GithubContributionDays); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.GithubContributionDays = nil
	if err = a.L.LoadGithubContributionDays(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.GithubContributionDays); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyInviterInvitations(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, invitationDBTypes, false, invitationColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, invitationDBTypes, false, invitationColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.InviterInvitations().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	bFound, cFound := false, false
	for _, v := range check {
		if v.InviterID == b.InviterID {
			bFound = true
		}
		if v.InviterID == c.InviterID {
			cFound = true
		}
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadInviterInvitations(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.InviterInvitations); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.InviterInvitations = nil
	if err = a.L.LoadInviterInvitations(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.InviterInvitations); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyPasswordResets(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, passwordResetDBTypes, false, passwordResetColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, passwordResetDBTypes, false, passwordResetColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.PasswordResets().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadPasswordResets(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.PasswordResets); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.PasswordResets = nil
	if err = a.L.LoadPasswordResets(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.PasswordResets); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyAddOpAchievementUsers(t *testing.T) {
	var err error
...
func testUserToManyAddOpBlogs(t *testing.T) {
	var err error
...
func testUserToManyAddOpAuthorEntries(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddAuthorEntries(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.AuthorEntries[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.AuthorEntries[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.AuthorEntries().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpGithubContributionDays(t *testing.T) {
	var err error
	...
	var a User
	var b, c, d, e GithubContributionDay

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, userDBTypes, false, strmangle.SetComplement(userPrimaryKeyColumns, userColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*GithubContributionDay{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, githubContributionDayDBTypes, false, strmangle.SetComplement(githubContributionDayPrimaryKeyColumns, githubContributionDayColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*GithubContributionDay{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddGithubContributionDays(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.GithubContributionDays[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.GithubContributionDays[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.GithubContributionDays().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpInviterInvitations(t *testing.T) {
	var err error
	...
	var a User
	var b, c, d, e Invitation

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, userDBTypes, false, strmangle.SetComplement(userPrimaryKeyColumns, userColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*Invitation{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, invitationDBTypes, false, strmangle.SetComplement(invitationPrimaryKeyColumns, invitationColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*Invitation{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddInviterInvitations(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.ID != first.InviterID {
			t.Error("foreign key was wrong value", a.ID, first.InviterID)
		}
		if a.ID != second.InviterID {
			t.Error("foreign key was wrong value", a.ID, second.InviterID)
		}

		if first.R.Inviter != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.Inviter != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}

		if a.R.InviterInvitations[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.InviterInvitations[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.InviterInvitations().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManyAddOpPasswordResets(t *testing.T) {
	var err error
	...
	var a User
	var b, c, d, e PasswordReset

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, userDBTypes, false, strmangle.SetComplement(userPrimaryKeyColumns, userColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*PasswordReset{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, passwordResetDBTypes, false, strmangle.SetComplement(passwordResetPrimaryKeyColumns, passwordResetColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*PasswordReset{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddPasswordResets(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.PasswordResets[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.PasswordResets[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.PasswordResets().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToOneProfileUsingProfile(t *testing.T) {
	...
	queries.Assign(&local.ProfileID, foreign.ID)
...
func testUserToOneSetOpProfileUsingProfile(t *testing.T) {
	...
	for i, x := range []*Profile{&b, &c} {
		...
		if !queries.Equal(a.ProfileID, x.ID) {
...
func testUserToOneRemoveOpProfileUsingProfile(t *testing.T) {
	var err error
	...
	if err = a.SetProfile(ctx, tx, true, &b); err != nil {
		t.Fatal(err)
	}

	if err = a.RemoveProfile(ctx, tx, &b); err != nil {
		t.Error("failed to remove relationship")
	}

	count, err := a.Profile().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
	if count != 0 {
	...
	if !queries.IsValuerNil(a.ProfileID) {
...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Name`: `character varying`, `Email`: `character varying`, `FullName`: `character varying`, `AvatarFilename`: `character varying`, `PasswordDigest`: `character varying`, `Authority`: `integer`, `ProfileID`: `bigint`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
