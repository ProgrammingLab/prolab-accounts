...
func testUserToManySetOpGithubContributionDays(t *testing.T) {
	var err error
	...
	err = a.SetGithubContributionDays(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetGithubContributionDays(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.GithubContributionDays[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.GithubContributionDays[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testUserToManyRemoveOpGithubContributionDays(t *testing.T) {
	var err error
	...
	err = a.AddGithubContributionDays(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveGithubContributionDays(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.GithubContributionDays) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.GithubContributionDays[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.GithubContributionDays[0] != &e {
