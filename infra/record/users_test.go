...
func testUserToManySetOpBlogs(t *testing.T) {
	var err error
	...
	err = a.SetBlogs(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetBlogs(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpBlogs(t *testing.T) {
	var err error
	...
	err = a.AddBlogs(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveBlogs(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
