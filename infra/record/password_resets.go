...
var PasswordResetWhere = struct {
	...
	TokenDigest: whereHelperstring{field: `token_digest`},
...
var (
	passwordResetColumns               = []string{"id", "token_digest", "email", "user_id", "created_at", "updated_at"}
	passwordResetColumnsWithoutDefault = []string{"token_digest", "email", "user_id", "created_at", "updated_at"}
...
func (q passwordResetQuery) One(ctx context.Context, exec boil.ContextExecutor) (*PasswordReset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: failed to execute a one query for password_resets")
	}
...
func (q passwordResetQuery) All(ctx context.Context, exec boil.ContextExecutor) (PasswordResetSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "record: failed to assign all query results to PasswordReset slice")
	}
...
func (q passwordResetQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to count password_resets rows")
	}
...
func (q passwordResetQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "record: failed to check if password_resets exists")
	}
...
func FindPasswordReset(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*PasswordReset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: unable to select from password_resets")
	}
...
func (o *PasswordReset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("record: no password_resets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to insert into password_resets")
	}
...
func (o *PasswordReset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("record: unable to update password_resets, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update password_resets row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by update for password_resets")
	}
...
func (q passwordResetQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all for password_resets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected for password_resets")
	}
...
func (o PasswordResetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all in passwordReset slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected all in update all passwordReset")
	}
	return rowsAff, nil
}
...
func (o *PasswordReset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("record: no PasswordReset provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete from password_resets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by delete for password_resets")
	}
...
func (q passwordResetQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("record: no passwordResetQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from password_resets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by deleteall for password_resets")
	}
...
func (o PasswordResetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("record: no PasswordReset slice provided for delete all")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from passwordReset slice")
	}
...
func (o *PasswordResetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to reload all in PasswordResetSlice")
	}
...
func PasswordResetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "record: unable to check if password_resets exists")
	}
